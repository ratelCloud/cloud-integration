...
public class CacheFactory {
    ...
    /**
     * Redis缓存默认过期时间：一天 24*60*60;
     **/
    public static final int DEFAULT_REDIS_EXPIRE_TIME = 86400;
    ...
    public static long incrBy(String key, long detail) {
        return incrBy(key, detail, DEFAULT_REDIS_EXPIRE_TIME);
    }
     ...
     * @return
     */
    public static long incrByExpire(String key, long expireTime) {
        return incrBy(key,1,expireTime);
    }
    ...
    public static void putString(String key, String value) {
        ...
        try {
            ...
            logger.error("缓存数据失败：参数{}，异常信息{}", key,e);
        }
    }
    ...
    public static Set<String> keys(String prefix){
        return objectRedisTemplate.keys(prefix);
    }
    ...
    public static Map<String, Object> getHAll(String key) {
        ...
        keys.forEach(k -> map.put(k, hashOperations.get(key, k)));
        return map;
    }
    ...
    public static <T> Map<String, T> getHAll(String key, Class<T> clazz) {
        ...
        keys.forEach(k -> map.put(k, getHValue(key, k, clazz)));
        return map;
    }
     ...
     * @return
     */
    public static <T> T bRPop(String key, int seconds) {
